...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Description                                                              
%       Tracks movement of cells from tif stack images of cells.                                                                         
%                                                                         
%                                                                                                      
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%       Dependencies
...
function [namelist, cbound, valcube, r1, c1] = NCtraceWithSeed(namePre, namePost, tstr, CFPB, YFPB, sizeThres, maxI, invertLog) 
%load M
